...
export const priceActionContent = {
  zh: {
    title: '价格行为交易策略 - Pin Bar、Inside Bar、供需区域完整指南 | 明DAO',
    ...
    ctaDescription: '加入明DAO专业培训，学习裸K交易和供需区域策略',
  ...
  en: {
    title: 'Price Action Trading Strategy - Pin Bar, Inside Bar, Supply/Demand Zones Guide | 明DAO',
    ...
    ctaDescription: 'Join 明DAO professional training to learn naked trading and supply/demand strategies',
